...
const CandidateRegistrationForm = () => {
  ...
  const validateForm = () => {
    const { name, gender, email, password, department, registerNo, dateOfBirth, mobileNumber, partySymbol, partyName, position,year } = formData;
    const errors = {};
    ...
    <div className="registration-form">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          ...
          {errors.position && <span className="error">{errors.year}</span>}
        </div>
        <div className="bt">
